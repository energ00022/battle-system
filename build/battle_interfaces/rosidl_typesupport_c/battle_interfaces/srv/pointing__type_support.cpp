...
static const _Pointing_Request_type_support_symbol_names_t _Pointing_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, battle_interfaces, srv, Pointing_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, battle_interfaces, srv, Pointing_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, battle_interfaces, srv, Pointing_Request)() {
  return &::battle_interfaces::srv::rosidl_typesupport_c::Pointing_Request_message_type_support_handle;
}
...
static const _Pointing_Response_type_support_symbol_names_t _Pointing_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, battle_interfaces, srv, Pointing_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, battle_interfaces, srv, Pointing_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, battle_interfaces, srv, Pointing_Response)() {
  return &::battle_interfaces::srv::rosidl_typesupport_c::Pointing_Response_message_type_support_handle;
}
...
static const _Pointing_type_support_symbol_names_t _Pointing_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, battle_interfaces, srv, Pointing)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, battle_interfaces, srv, Pointing)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, battle_interfaces, srv, Pointing)() {
  return &::battle_interfaces::srv::rosidl_typesupport_c::Pointing_service_type_support_handle;
}
