...
static const _TargetArray_type_support_symbol_names_t _TargetArray_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, battle_interfaces, msg, TargetArray)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, battle_interfaces, msg, TargetArray)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, battle_interfaces, msg, TargetArray)() {
  return &::battle_interfaces::msg::rosidl_typesupport_c::TargetArray_message_type_support_handle;
}
