...
#include "battle_interfaces/msg/detail/target_array__rosidl_typesupport_fastrtps_c.h"
...
#include "battle_interfaces/msg/detail/target__functions.h"  // targets
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPORT_battle_interfaces
...
using _TargetArray__ros_msg_type = battle_interfaces__msg__TargetArray;
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: targets
  {
    ...
    if (ros_message->targets.data) {
      battle_interfaces__msg__Target__Sequence__fini(&ros_message->targets);
    }
...
size_t get_serialized_size_battle_interfaces__msg__TargetArray(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _TargetArray__ros_msg_type * ros_message = static_cast<const _TargetArray__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _TargetArray__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_battle_interfaces__msg__TargetArray(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_battle_interfaces
size_t max_serialized_size_battle_interfaces__msg__TargetArray(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = battle_interfaces__msg__TargetArray;
    is_plain =
      (
...
static size_t _TargetArray__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_battle_interfaces__msg__TargetArray(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, battle_interfaces, msg, TargetArray)() {
